%   This function runs the DCP_BACF tracker on the video specified in "seq".
%   This function is based on the BACF tracker. 

function results = run_OMAL(seq, video_path, lr, x, y)
% HOG feature parameters
hog_params.nDim   = 31;         
params.video_path = video_path; 
% Grayscale feature parameters
grayscale_params.colorspace='hog';
...
params.numsample =500; 
params.affsig = [1.5,1.5,0.005,0,0,0]; 

% Debug and visualization 
params.visualization = 1; 

% Run the main function
results = OMAL_optimized(params,x,y);
